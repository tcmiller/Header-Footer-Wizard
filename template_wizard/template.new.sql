...
CREATE TABLE footer (id integer primary key autoincrement, blockw binary, wordmark binary, color enum('purple','gold'), patch binary, created_date datetime, last_modified datetime, account_id integer);
